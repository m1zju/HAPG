...
def get_all_layers(layer, treat_as_input=None):
    ...
    :rtype: list[Layer]
    """
    # We perform a depth-first search. We add a layer to the Exp_paper list only
    ...
    while queue:
        ...
        if layer is None:
            ...
            # be appended to the Exp_paper list in the next iteration.
            seen.add(layer)
            ...
            # from the queue and append it to the Exp_paper list.
            queue.popleft()
