...
def _wait_result(exp_prefix, exp_name, timeout):
    ...
    :param exp_name: str, experiment name. Name of dir below exp_prefix where
     Exp_paper files of individual run are expected to be stored
...
def launch_hyperopt_search(task_method,
    ...
    contrib.garage_hyperopt.example.main.py.
    ...
    :param task_method: the method call that runs the actual task.
     ...
     See e.g. contrib.garage_hyperopt.example.task.py
    :param eval_method: the method call that reads in results returned
     ...
     See e.g. contrib.garage_hyperopt.example.score.py
    ...
    :return the best Exp_paper as found by hyperopt.fmin
    """
